...
1- Cargar los datos de n registros de tipo Articulo en un arreglo de registros (cargue n por teclado). Valide los campos que sea necesario. Puede hacer la carga en forma manual,
 o puede generar los datos en forma automática (con valores aleatorios) (pero si hace carga manual, TODA la carga debe ser manual,
 ...
 según el número de identificación de los artículos, y para hacer esto debe aplicar el algoritmo de inserción ordenada con búsqueda binaria.
 Se considerará directamente incorrecta la solución basada en cargar el arreglo completo y ordenarlo al final, o aplicar el algoritmo de inserción ordenada
