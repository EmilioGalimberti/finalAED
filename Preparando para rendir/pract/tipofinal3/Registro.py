class Programa:
    ...
    def __str__(self):
        ...
        renglon += '   '
        renglon += '{:>15}'.format(self.nombre)
        renglon += ' '
        renglon += '{:>55}'.format(self.descripcion)
        renglon += '{:>15}'.format(self.cantidad)
        renglon += '  '
        renglon += '{:>15}'.format(self.tipo_deporte)
        renglon += '  '
        renglon += '{:>15}'.format(self.nivel)
        return renglon

#Recordad como funcaba el format
